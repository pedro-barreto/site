...
export default function Footer() {
  return (
    <footer className="h-28 p-5 bg-cor1 text-gray-700 flex flex-col justify-center items-center font-bold border-t border-black 2xl:border dark:bg-gray-700 dark:border-white dark:text-gray-300">
