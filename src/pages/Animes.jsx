...
import Anime01 from "../img/animes/anime01.webp";
import Anime02 from "../img/animes/anime02.webp";
import Anime03 from "../img/animes/anime03.webp";
import Anime04 from "../img/animes/anime04.webp";
import Anime05 from "../img/animes/anime05.webp";
import Anime06 from "../img/animes/anime06.webp";
import Anime07 from "../img/animes/anime07.webp";
import Anime08 from "../img/animes/anime08.webp";
import Anime09 from "../img/animes/anime09.webp";
import Anime10 from "../img/animes/anime10.webp";
import Anime11 from "../img/animes/anime11.webp";
import Anime12 from "../img/animes/anime12.webp";
import Anime13 from "../img/animes/anime13.webp";
import Anime14 from "../img/animes/anime14.webp";
import Anime15 from "../img/animes/anime15.webp";
import Anime16 from "../img/animes/anime16.webp";
import Anime17 from "../img/animes/anime17.webp";
import Anime18 from "../img/animes/anime18.webp";
import Anime19 from "../img/animes/anime19.webp";
import Anime20 from "../img/animes/anime20.webp";
import Anime21 from "../img/animes/anime21.webp";
import Anime22 from "../img/animes/anime22.webp";
import Anime23 from "../img/animes/anime23.webp";
import Anime24 from "../img/animes/anime24.webp";
...
export default function Jogos() {
  return (
    <div className="flex flex-col justify-center items-center bg-cor4-100 dark:bg-gray-600">
      ...
      <div className="flex flex-wrap justify-around p-5 sm:p-0">
        {animesCards.map((index, key) => (
          <CardAnime
            key={key}
            titulo={index.titulo}
            foto={index.foto}
...
const animesCards = [
  ...
  {
    titulo: "Zen: Grogu e as Criaturas do Studio Ghibli",
    foto: Anime24,
    sinopse:
      "O filme é uma aventura mágica que combina o universo encantador de Studio Ghibli com a adorável presença de Grogu, o amado personagem de Star Wars. Quando Grogu se separa de Mando, sua jornada o leva a um mundo repleto de criaturas extraordinárias e paisagens deslumbrantes, onde ele encontra seres místicos e seres mágicos que desafiam a imaginação.",
    info: {
      duracao: "0h 03m",
      data: "2022",
      avaliacao: "4.1",
