...
export default function Acessorios() {
  ...
  return (
    <main className="w-full px-3 pb-14 pt-0 sm:p-14 sm:pt-0 bg-cor2 dark:bg-gray-600">
      <h1 className={titulo}>ARTE 1</h1>

      <section className={secao}>
        <div className="row-span-2 col-span-6 border-2 border-black">
          <img src={artes[0]} className={styleImg} alt="" />
        </div>
        <div className="row-span-6 col-span-6 border-2 border-black">
          <img src={artes[1]} className={styleImg} alt="" />
        </div>
        <div className="row-span-4 col-span-3 border-2 border-black">
          <img src={artes[2]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-3 border-2 border-black">
          <img src={artes[3]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-3 border-2 border-black">
          <img src={artes[4]} className={styleImg} alt="" />
        </div>
      </section>
      ...
      <section className={secao}>
        <div className="row-span-4 col-span-8 border-2 border-black">
          <img src={artes[5]} className={styleImg} alt="" />
        </div>
        <div className="row-span-4 col-span-4 border-2 border-black">
          <img src={artes[6]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-3 border-2 border-black">
          <img src={artes[7]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-3 border-2 border-black ">
          <img src={artes[8]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-3 border-2 border-black">
          <img src={artes[9]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-3 border-2 border-black">
          <img src={artes[10]} className={styleImg} alt="" />
        </div>
      </section>
      ...
      <section className={secao}>
        <div className="row-span-3 col-span-3 border-2 border-black">
          <img src={artes[11]} className={styleImg} alt="" />
        </div>
        <div className="row-span-6 col-span-3 border-2 border-black">
          <img src={artes[12]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-6 border-2 border-black">
          <img src={artes[13]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-6 border-2 border-black">
          <img src={artes[14]} className={styleImg} alt="" />
        </div>
        <div className="row-span-3 col-span-3 border-2 border-black">
          <img src={artes[15]} className={styleImg} alt="" />
        </div>
        <div className="row-span-2 col-span-6 border-2 border-black">
          <img src={artes[16]} className={styleImg} alt="" />
        </div>
      </section>
    </main>
  );
